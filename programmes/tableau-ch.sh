...
if [ "$lang" = "chinois" ]; then
    ...
    # Ensuite, on redirige la sortie vers le fichier de contexte.
        ...
        echo "<tr>
                ...
                <td>$lineno</td><td><a href="$URL">$decoded_url</a></td><td><a href=\"$asp\">Aspiration</a></td><td><a href=\"$dump\">Dump</a></td><td>$reponse</td><td>$encoding</td><td>$occurence</td><td><a href=\"$cont\">Voir contexte</a></td><td><a href='$concordancier'>Concordancier</a></td></tr>" >> "$tab"
